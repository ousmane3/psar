 ...
 */
 ...
 /*@bgen(jjtree) constante */
  ...
  jjtree.openNodeScope(jjtn000);Token a;String s;
    try {
      a = jj_consume_token(CONSTANTE);
                    jjtree.closeNodeScope(jjtn000, true);
                    jjtc000 = false;
                   s=a.image;jjtn000.value = s;
    } finally {
    if (jjtc000) {
      jjtree.closeNodeScope(jjtn000, true);
    }
 ...
 /*@bgen(jjtree) variable */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token b;String s;
    try {
      b = jj_consume_token(VARIABLE);
     jjtree.closeNodeScope(jjtn000, true);
     jjtc000 = false;
    s=b.image;jjtn000.value = s;
    } finally {
    if (jjtc000) {
      jjtree.closeNodeScope(jjtn000, true);
    }
...
/*prédicats de comparaison de couleur binaire*/
 ...
 /*@bgen(jjtree) mc */
  ...
  final public void _col() throws ParseException {
    jj_consume_token(13);
  }
...
/*prédicats de comparaison de  position binaire*/
 ...
 /*@bgen(jjtree) ed */
  ...
  final public void _est_de() throws ParseException {
    jj_consume_token(21);
  }
 ...
 /*@bgen(jjtree) od */
  ...
  final public void _ouest_de() throws ParseException {
    jj_consume_token(22);
  }
 ...
 /*@bgen(jjtree) nd */
  ...
  final public void _nord_de() throws ParseException {
    jj_consume_token(23);
  }
 ...
 /*@bgen(jjtree) sd */
  ...
  final public void _sud_de() throws ParseException {
    jj_consume_token(24);
  }
 ...
 /*@bgen(jjtree) ma */
  ...
  final public void _mm_latitude() throws ParseException {
    jj_consume_token(25);
  }
 ...
 /*@bgen(jjtree) mo */
  ...
  final public void _mm_longitude() throws ParseException {
    jj_consume_token(26);
  }
...
/*prédicats de comparaison de position ternaire*/
 ...
 /*@bgen(jjtree) en */
  ...
  final public void _est_entre() throws ParseException {
    jj_consume_token(27);
  }
...
/*prédicats de comparaison de taille */
 ...
 /*@bgen(jjtree) pp */
  ...
  final public void _plus_petit() throws ParseException {
    jj_consume_token(31);
  }
 ...
 /*@bgen(jjtree) pg */
  ...
  final public void _plus_grand() throws ParseException {
    jj_consume_token(32);
  }
 ...
 /*@bgen(jjtree) mt */
  ...
  final public void _mm_taille() throws ParseException {
    jj_consume_token(33);
  }
...
/*prédicats d'égalité*/
 ...
 /*@bgen(jjtree) eq */
  ...
  final public void _est_egal() throws ParseException {
    jj_consume_token(34);
  }
